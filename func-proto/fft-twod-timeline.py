...
freqdomain = numpy.abs(fftshift(fft(timedomain)))
...
freqdomain2d = numpy.abs(fftshift(fft(timedomain2d, axis=0), axes=(0,) ))

print freqdomain
print freqdomain2d[:,0,0] / freqdomain
print freqdomain2d[:,0,1] / freqdomain
print freqdomain2d[:,1,0] / freqdomain
print freqdomain2d[:,1,1] / freqdomain
print freqdomain2d[5]
